...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        public async Task EnsureSeedData()
        {
            ...
            //Testing to see if existing email exists if not add that 
            if(await _userManager.FindByEmailAsync("mr.dopinion@gmail.com") == null)
            {
                var user = new WorldUser()
                {
                    UserName = "danmarkopinion",
                    Email = "mr.dopinion@gmail.com"
                };
